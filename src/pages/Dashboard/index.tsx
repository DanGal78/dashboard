...
import {Chart as ChartJS, CategoryScale, LinearScale,LineElement, PointElement, Title, Tooltip,Filler,Legend,} 
from "chart.js";
...
export default function Dashboard() {
    ...
    const options = {
        ...
        plugins:{
            ...
            title: {  
                display: true,
                text: "Grafico de vendas semanais"
            },
        },
    };
    const labels = [
    ...
    return (
        <main className={`${styles.main} ${styles.grid}`}>
            ...
            <Card title="Suportes Atendidos" goal="100%" reached="70%" percentage={30}/> 
            <Card title="Vendas Efetuadas" goal="500" reached="350" percentage={75}/> 
            <Card title="Satisfação Geral" goal="100% " reached="80%" percentage={80}/>
            </header>
            <section className={styles.sectionCard}>
                ...
                <div className={styles.cardContainer}>
                    ...
                    <Chart options={options} type="line" data={data} id="chart" className={styles.chart} ref={chartRef} />
