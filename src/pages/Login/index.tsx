...
const schema = yup.object().shape({
    email: yup
    .string().typeError("Os dados envidos são inválidos")
    .email("O email informado não e válido")
    .required("Informe seu email"),
    senha: yup
    .string().typeError("Os dados envidos são inválidos")
    .min(8,"Sua senha deve conter ao memos 8 caracteres")
...
const onSubmit =(dados:LoginData) =>{
    ...
    <div className={styles.container} >
        ...
        <div className={styles.mainFooter}>
            <p>Ainda não possue conta? <Link to="/registro"> Cadastre-se</Link></p>
        </div>      
    </main>
    </form>
    </div>
